...
This page uses the same business flows with framework-specific APIs.

## Scenario A — Login success

<Tabs groupId="scenario-login-success-en">
...
<Tabs groupId="scenario-delete-invoice-en">
  <TabItem value="playwright" label="Playwright" default>
...
<Tabs groupId="scenario-custom-dropdown-en">
  <TabItem value="playwright" label="Playwright" default>
...
- Same flow, different framework APIs.
- Keep locator strategy and review checklist consistent across frameworks.
